...
Create a `.env` file in `research2build/`:
...
Open a terminal in the `research2build/` directory:
...
Open a **separate terminal** in the `research2build/frontend/` directory:

#### **Windows / macOS / Linux:**

```bash
cd research2build/frontend
...
Edit `research2build/.env` to configure your LLM and vector store backends:
...
Automated deployment scripts are located in `research2build/scripts/`:
